...
// WrapPublicKey converts an already-parsed public key object — for P-256, a standard library
// *ecdsa.PublicKey on the P-256 curve — into a PublicKey. It is the inverse of Unwrap. The boolean
